...
def seg_and_patch(source, save_dir, patch_save_dir, mask_save_dir, stitch_save_dir, 
				  ...
				  seg_params = {'seg_level': -1, 'sthresh': 10, 'mthresh': 9, 'close': 4, 'use_otsu': False,
...
parser.add_argument('--source', type = str, default='./dataset/TCGA/test/1',
...
parser.add_argument('--save_dir', type = str,default='my_data/test1',
