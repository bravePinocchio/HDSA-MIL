...
from models.single_model import CLAM_MB, CLAM_SB
...
def parse_config_dict(args, config_dict):
	if args.save_exp_code is not None:
		config_dict['exp_arguments']['save_exp_code'] = args.save_exp_code  ## HEATMAP_OUTPUT
	if args.overlap is not None:
		config_dict['patching_arguments']['overlap'] = args.overlap  # 0.5
	return config_dict
...
if __name__ == '__main__':
	...
	patch_size = tuple([patch_args.patch_size for i in range(2)])  ## 256， 256
